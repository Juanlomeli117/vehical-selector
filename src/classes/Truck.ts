...
// TODO: The Truck class should extend the Vehicle class and should implement the AbleToTow interface
 ...
 class Truck extends Vehicle implements AbleToTow {
  ...
  tow(vehicle: Truck | Motorbike | Car | AbleToTow): void {
    const vehicleMake = (vehicle as Vehicle).make || 'Unknown make';
    const vehicleModel = (vehicle as Vehicle).model || 'Unknown model';
    const vehicleWeight = (vehicle as Vehicle).weight || 0; 
